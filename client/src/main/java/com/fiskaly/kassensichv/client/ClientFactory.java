...
public class ClientFactory {
     ...
     * @param sma The SMAImplementation-implementation according to the target platform
     ...
     */
    public static OkHttpClient getClient(String apiKey, String secret, SMAImplementation sma) {
    ...
    public static OkHttpClient getPersistingClient(String apiKey, String secret, SMAImplementation sma, PersistenceStrategy persistenceStrategy) {
        TokenManager tokenManager = new TokenManager(
                new OkHttpClient
                        .Builder()
                        .build(),
